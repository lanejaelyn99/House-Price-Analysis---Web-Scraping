...
for row in table.find_all("tr"):
    ...
    Revenue= col[1].text
    rows_data.append({"Date":Date,"Revenue":Revenue})
gme_revenue=pd.DataFrame(rows_data)
...
make_graph(tesla_data, tesla_revenue, 'Tesla Data for June of 2021')
...
make_graph(gme_data, gme_revenue, 'GameStop Data for June of 2021')
